    ...
    <section className="flex flex-1 flex-col items-center justify-center gap-6 px-4 py-12 text-center">
      <div className="space-y-2">
        <Heading level="h3" as="h2">
          Couldn&apos;t load Entertainment
        </Heading>
        <Text variant="muted">
          Something went wrong while loading this section. Try again or go back to the Entertainment overview.
        </Text>
        {error.digest && (
      ...
      <div className="flex flex-wrap items-center justify-center gap-3">
        ...
        <Button variant="outline" asChild>
          <Link href="/portal/entertainment">Back to Entertainment</Link>
        </Button>
      </div>
    </section>
  );
